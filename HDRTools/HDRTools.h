...
#define HDRTOOLS_VERSION "HDRTools 1.1.1 JPSDR"
...
class ConvertXYZ_ACES_HDRtoSDR : public GenericVideoFilter
{
public:
...
class ConvertRGB_ACES_HDRtoSDR : public GenericVideoFilter
{
public:
